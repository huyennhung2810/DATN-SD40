...
@Repository
public interface OrderChangeRequestRepository extends JpaRepository<OrderChangeRequest, String> {

    List<OrderChangeRequest> findByOrderIdOrderByCreatedDateDesc(String orderId);

    Page<OrderChangeRequest> findByChangeStatusOrderByCreatedDateDesc(
            ChangeRequestStatus changeStatus, Pageable pageable);

...
import { Table, Button, Modal, Form, Input, TimePicker, message, Tag, Space } from 'antd';
...
const ShiftTemplateManager = () => {
    ...
    const handleCreate = async (values) => {
        ...
        try {
            ...
            message.error(error.response?.data?.message || "Có lỗi xảy ra khi tạo ca");
        }
    };
    ...
    return (
        <div style={{ padding: '24px' }}>
            <div style={{ marginBottom: 16, display: 'flex', justifyContent: 'space-between' }}>
                <h2>Danh sách ca làm việc mẫu</h2>

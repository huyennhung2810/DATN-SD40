...
const WorkSchedulePage: React.FC = () => {
  ...
  const columns: ColumnsType<WorkScheduleResponse> = [
    ...
    {
      title: "Thao tác",
      key: "action", // Nên có key cho column
      render: (_: string, record: WorkScheduleResponse) => {
        // Logic: Chỉ cho phép xóa nếu trạng thái là PENDING (hoặc chưa check-in)
        // Bạn hãy kiểm tra tên trường trạng thái trong record của bạn (status hoặc workScheduleStatus)
        const canDelete = record.workScheduleStatus === "PENDING";
        ...
        return (
          <Space>
            ...
            {canDelete ? (
              ...
              /* Nếu không được xóa, hiện nút disabled kèm Tooltip giải thích */

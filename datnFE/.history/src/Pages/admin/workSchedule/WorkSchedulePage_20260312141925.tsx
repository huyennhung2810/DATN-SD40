...
const WorkSchedulePage: React.FC = () => {
  ...
  const columns: ColumnsType<WorkScheduleResponse> = [
    ...
    },
    {
      ...
      key: "action",
      render: (_, record: any) => {
        // Giả sử record có trường status (PENDING, ONGOING, COMPLETED)
        // Hoặc bạn check dựa trên ngày giờ hiện tại
        const canDelete =
        ...
        return (
          <Space size="middle">
            {canDelete ? (
              ...
              <Tooltip title="Không thể xóa ca đã diễn ra hoặc hoàn thành">

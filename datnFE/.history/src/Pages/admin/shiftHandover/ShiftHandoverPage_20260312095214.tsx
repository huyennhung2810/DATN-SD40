...
const ShiftHandoverPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchTodaySchedule = async () => {
      ...
      try {
        ...
        // 404 hoặc lỗi nghĩa là hôm nay không có lịch trực
  ...
  return (
    <div style={{ padding: "24px", minHeight: "85vh", background: "#f0f2f5" }}>
              ...
              {!hasStartedShift ? (
                ...
                <div style={{ textAlign: "center", padding: "50px 0" }}>
                  ...
                  <Button
                    ...
                    disabled={!todaySchedule} // Vô hiệu hóa nếu không tìm thấy lịch trực
      ...
      {/* Modals điều khiển - Sử dụng ID linh hoạt */}
      <CheckInModal
      ...
      <CheckOutModal
        ...
        // Ưu tiên lấy workScheduleId từ trong ca đang chạy

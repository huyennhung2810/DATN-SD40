...
import ProfilePage from "./pages/admin/auth/ProfilePage";
import AccountSettingsPage from "./pages/admin/auth/AccountSettingsPage";
import RedirectPage from "./pages/admin/auth/RedirectPage";
...
// Wrapper to bootstrap auth on app load
const AuthBootstrap: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    // Bootstrap - fetch user if we have token but no user data

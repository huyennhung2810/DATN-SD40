...
const QuickAddCustomerModal: React.FC<QuickAddCustomerModalProps> = ({ open, onClose, onCreated }) => {
    ...
    const handleOk = async () => {
        try {
            ...
            message.error(error?.response?.data?.message || 'Lỗi khi tạo khách hàng mới');
        } finally {
            setLoading(false);
        }
    };
